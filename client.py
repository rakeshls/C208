...
def openChatWindow():
    ...
    textArea= Text(window,width=65,height=6,font=("Calibri",10))
    ...
    textMessage =Entry(window,width=40,font=("Calibri",12))
    textMessage.pack()
    textMessage.place(x=95,y=300)

    atachButton = Button(window,text="Atach and send", bd=1,font=("Calibri",10))
    atachButton.place(x=10,y=300)
